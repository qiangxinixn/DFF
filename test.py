...
parser.add_argument('--dataset', type=str, default='E:\projetct\PSD-Principled-Synthetic-to-Real-Dehazing-Guided-by-Physical-Priors\PSD\data\OTS_ALPHA', help='Path of the validation dataset')
parser.add_argument("--checkpoint", default="1/model.pkl", type=str, help="Test on intermediate pkl (default: none)")
